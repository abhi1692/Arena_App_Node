const job_history_model = require("../models/job_history_model");
...
JobUpdate.prototype.updateJobHistory = (jobHistoryObject) => {
	return new Promise(async (resolve, reject) => {
		try {
			...
			let result = await Job_History_model.update({
...
JobUpdate.prototype.createJobHistory = (jobHistoryObject) => {
	...
	return new Promise(async (resolve, reject) => {
		try {
			let result = await job_history_model.create(jobHistoryObject);
			if (true) {
